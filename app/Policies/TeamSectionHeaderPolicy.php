...
class TeamSectionHeaderPolicy
{
    ...
    {
        return $user->can('view_any_team::section::header');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, TeamSectionHeader $teamSectionHeader): bool
    {
        return $user->can('view_team::section::header');
    }
     ...
     */
    public function update(User $user, TeamSectionHeader $teamSectionHeader): bool
    {
        return $user->can('update_team::section::header');
    }
