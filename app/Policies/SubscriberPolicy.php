...
class SubscriberPolicy
{
    ...
    {
        return $user->can('delete_subscriber');
    }
    ...
    {
        return $user->can('delete_any_subscriber');
    }
    ...
    {
        return $user->can('force_delete_subscriber');
    }
    ...
    {
        return $user->can('force_delete_any_subscriber');
    }
    ...
    {
        return $user->can('restore_subscriber');
    }
    ...
    {
        return $user->can('restore_any_subscriber');
    }
