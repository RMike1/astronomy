<x-main-layout>
    <x-slot name="meta">
        <title> {{ $Homesection->meta_title }} - {{$general_setting->site_name}}</title>
        <meta name="keyword" content="{{ $Homesection->meta_keyword }}">
        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 py-20 lg:py-25 relative">
            ...
            <div class="flex gap-11 flex-wrap justify-between sm:grid sm:grid-cols-2">
                ...
                <div class="wow fadeInRight xl:block">
                    <img class="rounded-sm" src="{{ Storage::disk('images')->url($Homesection->image) }}" alt="{{ $Homesection->title }}" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            <div class="relative rounded-3xl z-999">
                ...
                <img class="rounded-xl" src="{{ Storage::disk('images')->url($Homesection->image) }}" alt="{{ $Homesection->title }}" />
            </div>
        </div>
    </section>
