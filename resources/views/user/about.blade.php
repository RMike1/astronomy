<x-main-layout>
            ...
            <div class="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
                <div class="absolute inset-0 top-0 left-0 w-full h-full">
                    <video class="video-bg absolute inset-0 w-full h-full object-cover" autoplay muted loop>
                        <source src="{{ asset('user/video/about-video.mp4') }}" type="video/mp4">
        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 py-20 lg:py-25 relative">
            ...
            <div class="flex gap-11 flex-wrap justify-between">
                <div class="wow fadeInLeft max-w-[570px] w-full">
                    <span class="hero-subtitle-text font-semibold block mb-5">About Our Journey</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 lg:gap-17.5">
                ...
                <div class="wow fadeInUp group text-center">
                    ...
                    <div class="flex items-center justify-center gap-5">
                        <a href="about.html#" class="hover:text-white ease-in duration-300">
    ...
    <section x-data="{ 'showContent': false, 'scrollContent': false, }" class="relative z-20 overflow-hidden pb-20">
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div :class="[ showContent ? 'sticky -u-mt-52 transition-opacity duration-300 opacity-0' : '', scrollContent ? '!opacity-100' : '' ]"
